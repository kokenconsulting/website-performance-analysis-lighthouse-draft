...
import { ThrottledAuditResultModel } from "./ThrottledAuditResultModel";
import { LighthouseAuditReport } from '../lighthouse/LighthouseAuditReport';
...
export class ThrottledAuditReport extends BaseReport {
    ...
    private extractNumericValue(jsonObject: any): any {
